...
public final class FileProcessor {
	...
	*/
	public FileProcessor(String inputFilePath)
		...
		MyLogger.writeMessage("In File Processor Constructor",MyLogger.DebugLevel.CONSTRUCTOR);
	...
	*/
	public String poll() throws IOException {
		MyLogger.writeMessage("In File Processor ReadLine",MyLogger.DebugLevel.FILE_PROCESSOR);
